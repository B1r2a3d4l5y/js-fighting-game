  ...
  calcAttack: function() {
    ...
    let playerAttack = function() {
      ...
      let enemyAttack = function() {
        ...
        // Get player/ enemy health to change for later
        let  getPlayerHealth = document.querySelector(".health-player");
          ...
          if (getPlayerSpeed >= getEnemySpeed) {
            ...
            alert("You hit" + playerAttackValues[0]  + "damage" + playerAttackValues + "times.");
            if (enemy.health <= 0) {
              ...
              alert("Enemy hit" + enemyAttackValues[0]  + "damage" + enemyAttackValues + "times.");
              if (player.health <= 0) {
